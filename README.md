...
* In `Direct Coupling` the individual amplifier stage bias condition are designed in a way that the two stages may be directly connected without the necessity for `DC ISOLATION`.
